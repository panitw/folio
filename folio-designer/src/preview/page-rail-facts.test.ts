...
describe('the collaborators the vendored thumbnail view reaches for', () => {
  ...
  // viewer uses this bus to drive other components, and folio has none, so a bus
  ...
  it('takes the pdf.js chrome back off the DOM folio wraps in its own button', () => {
    ...
    // 62px well — the two facts pdf.js sets for a viewer application folio does
    // not have.
