...
- **Format versioning is a 4.x MINOR change.** A one-page document keeps its file bytes, its declared version and its PDF hash. Only documents with more than one page declare the new minor.
