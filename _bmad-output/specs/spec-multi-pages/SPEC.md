...
- **Selecting a page shows Page Setup.** A section for the selected page, holding its Page Break checkbox, appears first, above the document-wide settings. A page becomes selected when the author clicks empty space on any of its sheets or clicks its page label.
