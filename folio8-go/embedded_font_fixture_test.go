...
// folio8-go/fonts/notosansthai/NotoSansThai-Regular.ttf the module already
...
` + data.String() + `
      ...
      "font": {
        ...
        "source": "folio8-go/fonts/notosansthai/NotoSansThai-Regular.ttf — the shipped static Regular instance; see that directory's NOTICE.md for the derivation",
        "style": "Regular"
      },
      "mediaType": "font/ttf"
    }
