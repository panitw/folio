...
// (production: exactly folio8-go/internal/pdf/; fixture: a tree standing
...
// D-1.3.2 to scope exactly folio8-go/internal/pdf/ (AC7): the production
...
func TestNumberFormattingIsConfinedToNumbersGo(t *testing.T) {
	...
	pdfDir := filepath.Join(root, "folio8-go", "internal", "pdf")
...
// folio8-go/testdata/lint/numeric-formatting/ (never under
// folio8-go/internal/, F-10):
...
func TestNumberFormattingFixtureScan(t *testing.T) {
	root := repoRootFromTest(t)
	fixtureRoot := filepath.Join(root, "folio8-go", "testdata", "lint", "numeric-formatting")
