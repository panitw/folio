...
func TestDiagPackageHasZeroFirstPartyImports(t *testing.T) {
	...
	for _, entry := range entries {
		...
		for _, imp := range file.Imports {
			...
			// import path — "github.com/panitw/folio8/folio8-go" itself
			// (the root `folio8` package) or anything beneath it
			// ("github.com/panitw/folio8/folio8-go/internal/...").
			...
			if value == "github.com/panitw/folio8/folio8-go" ||
				strings.HasPrefix(value, "github.com/panitw/folio8/folio8-go/") {
