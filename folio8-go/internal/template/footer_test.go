...
// in folio8.ParseTemplate (folio8-go/folio8_expr_validate.go's
// validateAndDeriveExpressions/validateTableColumns, invoked from
// ParseTemplate — folio8-go/folio8.go). template.ParseDocument staying
...
// TestParseTemplateDerivesFooterOfShape1/Shape2 (folio8-go's own
