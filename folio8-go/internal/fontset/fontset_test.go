...
// folio8-go/testdata/fonts/Roboto-Regular.ttf.
func testFontBytes(t *testing.T) []byte {
	t.Helper()
	// internal/fontset -> internal -> folio8-go
...
// folio8-go/testdata/fonts/notosansthai-variable-testonly/NotoSansThai-VF.ttf
// — used ONLY to exercise axis pinning/instancing in this package's own
// tests (V5). It is NOT the shipped copy (folio8-go/fonts/notosansthai/).
