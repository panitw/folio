...
// 2026-09-03, wd folio8-go, `go test ./internal/fontset/`): with the body of
...
// folio8-designer/src/generated/font-catalogue.ts, is gitignored and TS-only.
//
...
func TestGoLicenceTableSubsumesTheDesignerTable(t *testing.T) {
	path := filepath.Join("..", "..", "..", "folio8-designer", "src", "font-catalogue.test.ts")
	...
	tokenPath := filepath.Join("..", "..", "..", "folio8-designer", "src", "font-licence.ts")
