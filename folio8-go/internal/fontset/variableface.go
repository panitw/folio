...
// `fvar` test that CAN ONLY REFUSE (folio8-designer/src/font-name-table.ts,
...
//
// THE TEST THAT TIES THEM is folio8-designer/src/font-variable-face-tie.test.ts,
// which reads THE SAME TWO FIXTURE FILES this module's own tests reach by
// //go:embed (folio8-go/testdata/fonts/notosansthai-variable-testonly/NotoSansThai-VF.ttf
// and folio8-go/testdata/fonts/Roboto-Regular.ttf) and asserts both arms over
