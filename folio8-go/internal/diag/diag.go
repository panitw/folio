...
// of this package and in folio8-go/render.go — it switches on
...
// five. This package is ranked 1 (folio8-go/internal/, stagerank.go)
...
const (
	...
	// folio8-go/folio8_expr_validate.go:316-320).
