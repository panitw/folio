...
// package under folio8-go/internal/, rather than to any one of them. It has
...
// real folio8-go/internal/ tree and asserts zero findings. It fails on a
...
// retained fixture tree at folio8-go/testdata/lint/no-float64/ (D-1.3.3;
// never under folio8-go/internal/, F-10) and asserts exactly the named
...
// (folio8-go/, root and below), not only folio8-go/internal/. Measured
...
func TestNoFloat64UnderModule(t *testing.T) {
	...
	moduleRoot := filepath.Dir(internalRoot) // folio8-go/
