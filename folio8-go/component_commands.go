...
// (folio8-designer/src/engine-protocol.ts) — the one number the transport
...
//
// THE MIRROR. folio8-designer/src/engine-protocol.ts declares this same list
...
func setBandHeight(t *Template, raw map[string]json.RawMessage) (CanvasProjection, error) {
	...
	// the first grid arithmetic in folio8-designer and a fourth spelling of a
