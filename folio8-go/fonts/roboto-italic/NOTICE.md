...
**THIS FILE IS BYTE-IDENTICAL TO `folio8-designer/public/fonts/roboto-italic/Roboto-Italic.ttf` ON
...
SILENTLY rather than loudly. `folio8-designer/src/font-binary-identity.test.ts` digest-ties the two
copies. `folio8-go/fonts/fonts_test.go`'s `TestShippedRobotoMatchesDesignerCatalogue` checks this
