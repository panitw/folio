...
**THIS FILE IS BYTE-IDENTICAL TO `folio8-designer/public/fonts/notosans-bold/NotoSans-Bold.ttf` ON
PURPOSE, AND THE BROWSER'S COPY DOES NOT FOLLOW THIS ONE AUTOMATICALLY.** This engine-side copy is
the one `tools/fontgen/instance_faces.py` writes and `make fonts-verify` re-derives and compares;
