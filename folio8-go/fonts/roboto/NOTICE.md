...
> **THIS FILE IS BYTE-IDENTICAL TO `folio8-designer/public/fonts/roboto/Roboto-Regular.ttf`,
...
> a claim two directories happen to agree on today. **`folio8-go/testdata/fonts/Roboto-Regular.ttf`
...
here — `folio8-go/starter_template_test.go` reads that file and intersects every name it declares
