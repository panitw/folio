// Package fonts holds folio8-go's shipped production faces — Story 2.2's
...
// folio8-go/fonts/, alongside its OFL-1.1 licence text and NOTICE (AD-26,
...
//
// fonts imports package folio8 (also module root, folio8-go/*.go) for its
...
// folio8-go/*.go, none of which imports this package. AC9's blockquote
...
// folio8-go/fontgen_matrix_test.go (//go:build matrix) proves it still
// reproduces.
...
// designer's own catalogue face (`folio8-designer/public/fonts/roboto/
...
// machine-checked property. folio8-go/testdata/fonts/Roboto-Regular.ttf is
...
// `shippedFaceSpecs.Family` (folio8-go/shipped_faces_test.go) is the TEST
...
// assumed: folio8-designer/font-index.json records the family's styles as
...
//
// THE STARTER IS NOT DOCUMENTED HERE TWICE. folio8-go's own
