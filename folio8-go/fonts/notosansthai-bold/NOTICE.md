...
`folio8-designer/public/fonts/notosansthai-bold/NotoSansThai-Bold.ttf` ON PURPOSE, AND THE BROWSER'S
COPY DOES NOT FOLLOW THIS ONE AUTOMATICALLY.** This engine-side copy is the one
