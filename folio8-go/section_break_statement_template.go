...
// whose transaction-code legend sits below a section break at 400pt. Forty
// rows cross the line on page 1, so the legend moves to an added page 2 at its
// declared position. No real customer data. It is the first committed document
// declaring "version": "4.1".
const sectionBreakStatementTemplateJSON = `{
  "assets": {},
  "bands": {
    "content": {
      "elements": [
