...
var faceCitations = map[string]faceCitation{
	"Noto Sans":      {File: "folio8-go/fonts/notosans/NotoSans-Regular.ttf", UnitsPerEm: 1000, PostScriptName: "NotoSans-Regular"},
	"Noto Sans Thai": {File: "folio8-go/fonts/notosansthai/NotoSansThai-Regular.ttf", UnitsPerEm: 1000, PostScriptName: "NotoSansThai-Regular"},
	"Noto Sans SC":   {File: "folio8-go/fonts/notosanssc/NotoSansSC-Regular.ttf", UnitsPerEm: 1000, PostScriptName: "NotoSansSC-Regular"},
}
