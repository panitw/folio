...
// scans only folio8-go/internal/ for a go:embed directive naming a font
...
// not the shipped copy (folio8-go/fonts/notosansthai/).
//
...
// (folio8-go/fonts/...), embedded a SECOND time directly here rather
// than obtained via `github.com/panitw/folio8/folio8-go/fonts`.Shipped().
