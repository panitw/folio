// Command gentrie regenerates folio8-go/internal/text/data/thai_words.trie
// from folio8-go/internal/text/wordlist/words_th.txt (Story 2.1, AC1).
//
// Run from the folio8-go module root:
//
//	go run ./cmd/gentrie
//
