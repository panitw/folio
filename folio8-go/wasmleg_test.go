...
// This file lives at the folio8-go module root (package folio8), NOT
// under internal/ — matching matrix_test.go's precedent. AD-1's
// forbidden-imports guard scans folio8-go/internal/ only; os/exec is
...
// AC10 and the Delivery Log). This builds folio8-go/internal/text's own
