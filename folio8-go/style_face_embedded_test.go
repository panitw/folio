...
// same folio8-go/fonts/notosansthai-bold/NotoSansThai-Bold.ttf the module
...
` + data.String() + `
	...
	assets := []string{
		asset(embeddedFontAssetKey(), embeddedFontAssetBytes(), "Noto Sans Thai", "Regular",
			testShippedNotoSansThaiLicence, "folio8-go/fonts/notosansthai/NotoSansThai-Regular.ttf"),
		asset(embeddedVariantBoldKey(), embeddedVariantBoldBytes(), "Noto Sans Thai Bold", "Bold",
			testShippedNotoSansThaiBoldLicence, "folio8-go/fonts/notosansthai-bold/NotoSansThai-Bold.ttf"),
	}
