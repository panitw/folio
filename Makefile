...
## fonts — derive folio8-go/fonts/*/​*-Regular.ttf from the upstream variable
...
## it needs to set appearing in any .go file under folio8-go/ (D-2.1.5),
...
## files without writing anything. This is what folio8-go's
