# SourceSerif4Display-Regular.ttf — Story 8.5 catalogue face
...
the family **`Source Serif 4 Display`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `source-serif-4.005_Desktop/TTF/SourceSerif4Display-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `549fdb8f9a682bd06944298621404969f6de77c2e422ff3b8244a1dcd6a0c425` (17,634,695 bytes) |
| **sha256 of the SOURCE (upstream) file** | `a1788d674713c99e61d4541c85e5cfbc3145c4e746b0185c674a0b15f7313295` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `SourceSerif4Display-Regular.ttf` |
| **sha256 of the SHIPPED file** | `a1788d674713c99e61d4541c85e5cfbc3145c4e746b0185c674a0b15f7313295` |
| Size | 296,680 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Source Serif 4 Display` |
| Relation to source | **copied unmodified, no derivation** — the two digests above are equal |

## The licence text beside this file

`LICENSE-OFL.md` is source-serif-4.005_Desktop/LICENSE.md (inside the release archive), copied unmodified.
