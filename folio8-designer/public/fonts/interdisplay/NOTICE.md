# InterDisplay-Regular.ttf — Story 8.5 catalogue face
...
the family **`Inter Display`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `extras/ttf/InterDisplay-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `9883fdd4a49d4fb66bd8177ba6625ef9a64aa45899767dde3d36aa425756b11e` (33,707,794 bytes) |
| **sha256 of the SOURCE (upstream) file** | `99614bda7ff423aaf470990692dd93613a5971ab4446e4a6d5a83b3d74865074` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `InterDisplay-Regular.ttf` |
| **sha256 of the SHIPPED file** | `99614bda7ff423aaf470990692dd93613a5971ab4446e4a6d5a83b3d74865074` |
| Size | 408,972 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Inter Display` |
| Relation to source | **copied unmodified, no derivation** — the two digests above are equal |

## The licence text beside this file

`LICENSE-OFL.txt` is LICENSE.txt (inside the release archive), copied unmodified.
