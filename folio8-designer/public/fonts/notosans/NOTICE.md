...
folio8-go's bundled `FontSet`, keyed as `"Noto Sans"`, providing Latin (and Greek/Cyrillic) glyph coverage
...
derivation; `folio8-go/fontgen_matrix_test.go` (`//go:build matrix`)
