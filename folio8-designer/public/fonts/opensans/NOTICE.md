# OpenSans-Regular.ttf — Story 16.1a local face tier batch
...
`scripts/build-wasm.mjs` reads `folio8-designer/font-catalogue.json`, fingerprints
this file into `src/generated/runtime/`, and emits one `@font-face` rule naming
the family **`Open Sans`** into `src/generated/runtime-fonts.css`.
...
| item | value |
|---|---|
| Upstream project | `github.com/googlefonts/opensans` — the project publishes no tagged release, so the pin is GitHub's source archive for the commit-snapshot release `bd7e37632246368c60fdcbd374dbf9bad11969b6` |
| Download URL | https://github.com/googlefonts/opensans/archive/bd7e37632246368c60fdcbd374dbf9bad11969b6.tar.gz |
| Path inside the archive | `opensans-bd7e37632246368c60fdcbd374dbf9bad11969b6/fonts/ttf/OpenSans-Regular.ttf` |
| Fetched | 2026-09-03 |
| sha256 of the release archive | `a1b16d859522daa826fb093d791ee252a1627274ef1b90f2773d670eb73a2a92` (30,976,885 bytes) |
| **sha256 of the SOURCE (upstream) file** | `c53aceea2dcf5b4098099c0c4d0a061d17e178a049317b42a422b1a9f7f8eb59` |
...
| item | value |
|---|---|
| **Shipped file** | `OpenSans-Regular.ttf` |
| **sha256 of the SHIPPED file** | `c53aceea2dcf5b4098099c0c4d0a061d17e178a049317b42a422b1a9f7f8eb59` |
| Size | 147,528 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Open Sans` |
...
Its sha256 is `01cd5ffb3a528c219a86e49a814c6c53bd8a69b9a3c305dd237074ba1c811af7` (4,216 bytes).
