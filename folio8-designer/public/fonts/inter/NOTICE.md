# Inter-Regular.ttf — Story 8.5 catalogue face
...
the family **`Inter`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `extras/ttf/Inter-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `9883fdd4a49d4fb66bd8177ba6625ef9a64aa45899767dde3d36aa425756b11e` (33,707,794 bytes) |
| **sha256 of the SOURCE (upstream) file** | `40d692fce188e4471e2b3cba937be967878f631ad3ebbbdcd587687c7ebe0c82` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `Inter-Regular.ttf` |
| **sha256 of the SHIPPED file** | `40d692fce188e4471e2b3cba937be967878f631ad3ebbbdcd587687c7ebe0c82` |
| Size | 411,640 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Inter` |
