# Oswald-Regular.ttf — Story 16.1a local face tier batch
...
the family **`Oswald`** into `src/generated/runtime-fonts.css`.
...
| item | value |
|---|---|
| Upstream project | `github.com/googlefonts/OswaldFont` — the project publishes no tagged release, so the pin is GitHub's source archive for the commit-snapshot release `89795261ac9eeb9aa8cd99f43982c4e4b0e53261` |
| Download URL | https://github.com/googlefonts/OswaldFont/archive/89795261ac9eeb9aa8cd99f43982c4e4b0e53261.tar.gz |
| Path inside the archive | `OswaldFont-89795261ac9eeb9aa8cd99f43982c4e4b0e53261/fonts/ttf/Oswald-Regular.ttf` |
| Fetched | 2026-09-03 |
| sha256 of the release archive | `134464e4de9076860d7b9cd8781fa515cce1a9ed5a39089f4b7cb614d3aac9b5` (12,474,371 bytes) |
| **sha256 of the SOURCE (upstream) file** | `0d9980da817ee71ad9c34bb46950fcf15dd53e928031f39d2e11ae19178ab826` |
...
| item | value |
|---|---|
| **Shipped file** | `Oswald-Regular.ttf` |
| **sha256 of the SHIPPED file** | `0d9980da817ee71ad9c34bb46950fcf15dd53e928031f39d2e11ae19178ab826` |
| Size | 105,572 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Oswald` |
...
Its sha256 is `0fd731a904b729a4e02eaf5e8ebd06783edd9abe400e8882760160230675b652` (4,483 bytes).
