# CascadiaMono-Regular.ttf — Story 8.5 catalogue face
...
the family **`Cascadia Mono`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/static/CascadiaMono-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `e67a68ee3386db63f48b9054bd196ea752bc6a4ebb4df35adce6733da50c8474` (150,454,761 bytes) |
| **sha256 of the SOURCE (upstream) file** | `06520d032ec274fa5040b22c6f4a1d829081b24ba40b2da56dae89bf10c7b481` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `CascadiaMono-Regular.ttf` |
| **sha256 of the SHIPPED file** | `06520d032ec274fa5040b22c6f4a1d829081b24ba40b2da56dae89bf10c7b481` |
| Size | 575,912 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Cascadia Mono` |
