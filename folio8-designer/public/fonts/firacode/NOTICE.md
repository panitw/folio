# FiraCode-Regular.ttf — Story 8.5 catalogue face
...
the family **`Fira Code`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `ttf/FiraCode-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `0949915ba8eb24d89fd93d10a7ff623f42830d7c5ffc3ecbf960e4ecad3e3e79` (2,462,987 bytes) |
| **sha256 of the SOURCE (upstream) file** | `5992ab9640e2df491b2f609467b1de60e8bc39b2c28db184342a0592d98f6117` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `FiraCode-Regular.ttf` |
| **sha256 of the SHIPPED file** | `5992ab9640e2df491b2f609467b1de60e8bc39b2c28db184342a0592d98f6117` |
| Size | 289,624 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Fira Code` |
| Relation to source | **copied unmodified, no derivation** — the two digests above are equal |

## The licence text beside this file

`LICENSE-OFL.txt` is LICENSE at tag 6.2 of github.com/tonsky/FiraCode (the release archive carries no licence file), copied unmodified.
