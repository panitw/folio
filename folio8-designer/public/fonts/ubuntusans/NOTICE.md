# UbuntuSans-Regular.ttf — Story 8.5 catalogue face
...
the family **`Ubuntu Sans`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `UbuntuSans-fonts-1.006/ttf/UbuntuSans-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `20aa7af47beaa6d64327782f7bf60df375edeedbdee2fe407e0bf9721890fb83` (29,602,887 bytes) |
| **sha256 of the SOURCE (upstream) file** | `74f238be44ac5e2ad41021f0b4acc5ccc66f585d06c36b22931319d9751d50ea` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `UbuntuSans-Regular.ttf` |
| **sha256 of the SHIPPED file** | `74f238be44ac5e2ad41021f0b4acc5ccc66f585d06c36b22931319d9751d50ea` |
| Size | 487,492 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Ubuntu Sans` |
| Relation to source | **copied unmodified, no derivation** — the two digests above are equal |

## The licence text beside this file

`LICENSE-UFL.txt` is UbuntuSans-fonts-1.006/LICENCE.txt (inside the release archive), copied unmodified.
