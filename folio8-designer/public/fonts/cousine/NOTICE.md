# Cousine-Regular.ttf — Story 8.5 catalogue face
...
the family **`Cousine`** into `src/generated/runtime-fonts.css`.
...
`folio8-go/fonts` ships the three Noto faces the engine measures with; AD-17
...
| item | value |
|---|---|
| Upstream project | `github.com/googlefonts/cousine`, release `v1.241` |
| Download URL | https://github.com/googlefonts/cousine/releases/download/v1.241/cousine-v1.241.zip |
| Path inside the archive | `cousine-v1.241/fonts/ttf/Cousine-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `05e98396538fe59bddab7d631467a9a93b17f8461c7673d493c5b72dc37610e7` (1,712,494 bytes) |
| **sha256 of the SOURCE (upstream) file** | `1da22250675fc4c42fcf3a9736c44bc0570516105331443b663fd5cfbd1412fe` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `Cousine-Regular.ttf` |
| **sha256 of the SHIPPED file** | `1da22250675fc4c42fcf3a9736c44bc0570516105331443b663fd5cfbd1412fe` |
| Size | 296,856 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Cousine` |
| Relation to source | **copied unmodified, no derivation** — the two digests above are equal |

## The licence text beside this file

`LICENSE-OFL.txt` is cousine-v1.241/OFL.txt (inside the release archive), copied unmodified.
Its sha256 is `b81c4d4dc0a9f72c9155e78187316e016e2012a8102468804173dc61468b906d` (4,387 bytes).
