# Literata-Regular.ttf — Story 8.5 catalogue face
...
the family **`Literata`** into `src/generated/runtime-fonts.css`.
...
| item | value |
|---|---|
| Upstream project | `github.com/googlefonts/Literata`, release `3.103` |
| Download URL | https://github.com/googlefonts/literata/releases/download/3.103/3.103.zip |
| Path inside the archive | `fonts/ttf/Literata-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `f7fb973cafb26cf785cbebaeaf51c18f87c15a3bcf4d82a7d4857564db5b056d` (17,546,949 bytes) |
| **sha256 of the SOURCE (upstream) file** | `0390890de9bb9d5862a6ba4125b82c61792ccc3d66b63e73eee75c1a16fcd208` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `Literata-Regular.ttf` |
| **sha256 of the SHIPPED file** | `0390890de9bb9d5862a6ba4125b82c61792ccc3d66b63e73eee75c1a16fcd208` |
| Size | 319,964 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Literata` |
...
Its sha256 is `8742963604cd89dc81437811a850018fc03b2bfad686d7422c8235967c87614e` (4,389 bytes).
