# RobotoMono-Regular.ttf — Story 16.1a local face tier batch
...
the family **`Roboto Mono`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `RobotoMono-3.001/fonts/ttf/RobotoMono-Regular.ttf` |
| Fetched | 2026-09-03 |
| sha256 of the release archive | `677d8513918572700531a3115f721a416557a5c701b150abc4d118a7177c8bdc` (4,516,663 bytes) |
| **sha256 of the SOURCE (upstream) file** | `af0bff7599c3df3831755c16e39b3c496df74b8c8d8a1161b14dc8461be17cb4` |
...
| item | value |
|---|---|
| **Shipped file** | `RobotoMono-Regular.ttf` |
| **sha256 of the SHIPPED file** | `af0bff7599c3df3831755c16e39b3c496df74b8c8d8a1161b14dc8461be17cb4` |
| Size | 125,748 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Roboto Mono` |
