# NotoSerifThai-Regular.ttf — Story 8.5 catalogue face
...
the family **`Noto Serif Thai`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `NotoSerifThai/unhinted/ttf/NotoSerifThai-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `89e3c04bfc54d9a5dd0aec660bf974ad46df38385df7d9397c083482d515049a` (5,733,486 bytes) |
| **sha256 of the SOURCE (upstream) file** | `538df2b3033522cd48bff18d536f76db60ec04e8cb3f44028fa92dbee8e6e125` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `NotoSerifThai-Regular.ttf` |
| **sha256 of the SHIPPED file** | `538df2b3033522cd48bff18d536f76db60ec04e8cb3f44028fa92dbee8e6e125` |
| Size | 26,496 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Noto Serif Thai` |
