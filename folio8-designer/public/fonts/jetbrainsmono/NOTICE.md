# JetBrainsMono-Regular.ttf — Story 8.5 catalogue face
...
the family **`JetBrains Mono`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `fonts/ttf/JetBrainsMono-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `6f6376c6ed2960ea8a963cd7387ec9d76e3f629125bc33d1fdcd7eb7012f7bbf` (5,622,857 bytes) |
| **sha256 of the SOURCE (upstream) file** | `a0bf60ef0f83c5ed4d7a75d45838548b1f6873372dfac88f71804491898d138f` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `JetBrainsMono-Regular.ttf` |
| **sha256 of the SHIPPED file** | `a0bf60ef0f83c5ed4d7a75d45838548b1f6873372dfac88f71804491898d138f` |
| Size | 273,900 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `JetBrains Mono` |
