# Geist-Regular.ttf — Story 8.5 catalogue face
...
the family **`Geist`** into `src/generated/runtime-fonts.css`.
...
| Path inside the archive | `geist-font/Geist/ttf/Geist-Regular.ttf` |
| Fetched | 2026-09-02 |
| sha256 of the release archive | `7fc800d2ac6b92844895196e5041aca55d814c15db70c44f79b3b83ab82b04e2` (8,207,303 bytes) |
| **sha256 of the SOURCE (upstream) file** | `5c8968eafb98a4c4f47033daf29e38e284a6f2a82eb017d171ab040fe7c4b615` |

## Provenance — the shipped artifact

| item | value |
|---|---|
| **Shipped file** | `Geist-Regular.ttf` |
| **sha256 of the SHIPPED file** | `5c8968eafb98a4c4f47033daf29e38e284a6f2a82eb017d171ab040fe7c4b615` |
| Size | 126,048 bytes |
| Instance | Regular — `OS/2.usWeightClass` 400, upstream static build |
| Declared family (`name` table) | `Geist` |
