...
// See folio8-go/go.mod for why the go directive sits below the toolchain
...
// folio8-go's and hashmatrix's floor and pin exactly, for the same reason.
go 1.25.0
...
// expected shape. Invariant (b), "no dependency added to folio8-go's
// module graph", still holds: this is lint's own graph, and folio8-go's
// go.mod is untouched.
